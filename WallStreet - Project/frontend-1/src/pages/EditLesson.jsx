...
//  call that state in your function to updaqte your database
    ...
    return (
        <div className='p-4 lesson'>
            <BackButton />
            <h1 className='text-3xl my-4 text-yellow-500 show-lesson'>Edit Lesson</h1>
            {loading ? <Spinner /> : ' '}
            <div className='flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-4 mx-auto'>

                <div className='my-4'>
                    <label className="text-xl mr-4 text-yellow-500">Category</label>
                    <input
                        type="text"
                ...
                <div className='my-4'>
                    <label className="text-xl mr-4 text-yellow-500">Lesson</label>
                    <textarea type="text"
                        value={lessonCard.lesson}
                        onChange={(e) => setLessonCard({...lessonCard, lesson: e.target.value})}
                        className='border-2 border-gray-500 px-4 py-8 w-full'
                    />
                </div>
                <div className='my-4'>
                    <label className="text-xl mr-4 text-yellow-500">Question</label>
                    <input type="text"
                ...
                <div className='my-4'>
                    <label className="text-xl mr-4 text-yellow-500">Answer</label>
                    <input type="text"
                ...
                <button className='p-2 bg-green-600 m-8' onClick={handleEditLesson}>
                    Save
                </button>
            </div>
        </div>
