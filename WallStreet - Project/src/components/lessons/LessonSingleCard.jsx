    ...
    return (
        ...
        >
            <div>
                ...
                {/* <h4 className='my-2 text-gray-500'>{lesson._id}</h4> */}
                ...
                <div className='table-btns'>
                    ...
                    <Link to={`/lessons/edit/${lesson._id}`}>
                        <div className='edit box tooltip'>
                        <span class="tooltiptext">Edit</span>
                            ✏️
                        </div>
                    </Link>                
                    <Link to={`/lessons/${lesson._id}`}>
                        <div className='trash tooltip'>
...
export default LessonSingleCard
