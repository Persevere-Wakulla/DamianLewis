...
const CreateLessons = () => {
    ...
    return (
        <div className='p-4'>
            <BackButton />
            <h1 className='text-3xl my-4'>Create Lesson</h1>
            {loading ? <Spinner /> : ' '}

            <div className='create-container center flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-4 mx-auto'>
            <div className='my-4' style={{marginTop: 10}}>
